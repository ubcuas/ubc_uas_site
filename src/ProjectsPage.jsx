...
const legacyProjects = [
  {
    ...
    img: DesertHawk,
    description:
      "Demanding real-world applications like Law Enforcement or Search And Rescue require high performance, multi-mission drones. The Advanced Technology Demonstrator was designed to be both a testbed of new drone technologies and the mission aircraft for the 2018 AUVSI SUAS competition. The Desert Hawk incorporated unique technologies and capabilities such as vortex generators and obstacle avoidance; it was also one of the first projects to include Augmented Reality prototyping to visualize subsystem integration. The project inspired growth and innovation for proceeding UBC UAS projects.",
  },
  {
    id: 15,
    title: "Raven",
      ...
      >
        <div className="info-page__content">
          ...
          <p className="info-page__body">
            Our projects are split into three distinct categories: aircraft,
            payload, and software. Aircraft houses our propulsion and
            electronics. Payload is the attachments we design to fulfill the
            tasks set out by our competitions. Software is the intelligence that
            enables autonomous mission execution.
          </p>
        </div>
      </section>
